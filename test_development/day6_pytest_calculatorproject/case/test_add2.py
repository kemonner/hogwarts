...
from test_development.day6_pytest_calculatorproject.case.base import Base
...
class TestAdd2(Base):
    ...
    def test_add_p0(self, x, y, expected):
        with allure.step("调用加法函数"):
            ...
            allure.attach.file(r"/Users/zxmac/Desktop/workspace/project/hogwarts/test_development/"
