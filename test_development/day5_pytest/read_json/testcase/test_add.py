import pytest
from test_development.day5_pytest.read_json.func.operation import my_add
import json


def test_get_json():
    with open("/Users/zxmac/Desktop/workspace/project/hogwarts/test_development/day5_pytest/read_json/data/"
