import pytest
from TestDevelopment.day4_pytest.read_excel.func.operation import test_add
import openpyxl
import os
# 判断表格是否存在
def get_excel():
    ...
    # 获取工作薄
    wb = openpyxl.load_workbook("/TestDevelopment/day4_pytest/"
    ...
    # wb.save("/Users/zxmac/Desktop/workspace/project/hogwarts/TestDevelopment/day4_pytest/read_excel/data/params.xlsx")
    # wb.close()
