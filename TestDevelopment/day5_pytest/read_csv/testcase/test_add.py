import pytest
from TestDevelopment.day5_pytest.read_csv.func.operation import my_add
import csv


def test_get_csv1():
    with open(r"/TestDevelopment/day5_pytest/read_csv/data/params.csv") \
            as file:
        raw = csv.reader(file)
...
def test_get_csv2():
    with open(r"/TestDevelopment/day5_pytest/read_csv/data/params1.csv") \
            as file:
        raw = csv.reader(file)
        print(type(raw), raw, "aaaaa")
        list1 = []
