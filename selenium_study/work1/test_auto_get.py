...
class TestAutoGet:
    ...
    def test_auto_get(self):
        ...
        imgcode = self.driver.find_element(By.CSS_SELECTOR, "#userLayout > div > div.main > div > form > div.ant-tabs."
                                                  "ant-tabs-top.ant-tabs-line > div.ant-tabs-content.ant-tabs-content-"
                                                  "animated.ant-tabs-top-content > div > div:nth-child(2) > form > "
                                                  "div:nth-child(3) > div.ant-col.ant-col-8 > img")
        # 识别后转变为文本
        ocr = ddddocr.DdddOcr()
        ...
        time.sleep(3)
        # 点击邮件管理
        self.driver.find_element_by_xpath("//*[@id='app']/section/aside/div/ul/li[11]/a").click()
        time.sleep(0.5)
        # 点击新增邮件
        ...
        # 从下拉选项中选择一个发件人
        time.sleep(1)
        self.driver.find_element_by_xpath("/html/body/div[6]/div[1]/div[1]/ul/li[2]/span").click()
        # 填入收件地址
        self.driver.find_element_by_xpath("/html/body/div[5]/div/div[2]/div/div[2]/div[2]/div/div/div/fieldset[1]/form"
        ...
        self.driver.find_element_by_xpath("/html/body/div[5]/div/div[2]/div/div[2]/div[2]/div/div/div/fieldset[1]/form"
                                          "/div/div[5]/div/div[2]/div/span/input").send_keys("0x5b0459900693a3b9d73b8f3"
                                                                                             "299e0bf0ed33c3db9")
        # 选择道具类型邮件
        self.driver.find_element(By.XPATH, "/html/body/div[5]/div/div[2]/div/div[2]/div[2]/div/div/div/fieldset[1]"
                                           "/form/div/div[6]/div/div[2]/div/span/div/div[1]/input").click()
        time.sleep(1)
        # 选择道具
        self.driver.find_element(By.XPATH, "/html/body/div[7]/div[1]/div[1]/ul/li[8]").click()
        time.sleep(0.5)
